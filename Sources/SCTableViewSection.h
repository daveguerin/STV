 ...
 *  @param cell That cell to be matched against. */
 ...
 *	@param sectionHeaderTitle A header title for the section.
 *	@param object The object that 'SCObjectSection' will use to generate its cells.
 *	@param store The data store for the bound object.
 *  @param group Limits the generated properties to the ones in the property group only.
 */
+ (instancetype)sectionWithHeaderTitle:(NSString *)sectionHeaderTitle
                 boundObject:(NSObject *)object
 ...
 *	@param sectionHeaderTitle A header title for the section.
 *	@param object The object that 'SCObjectSection' will use to generate its cells.
 *	@param store The boundObject data store.
 *  @param group Limits the generated properties to the ones in the property group only.
 */
- (instancetype)initWithHeaderTitle:(NSString *)sectionHeaderTitle
              boundObject:(NSObject *)object
...
@property (nonatomic, readwrite) BOOL hideWhenEmpty;
...
@property (nonatomic, readwrite) BOOL autoCommitDetailModelChanges;
