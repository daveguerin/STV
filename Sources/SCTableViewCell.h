 ...
 */
@property (nonatomic, readwrite) IBInspectable BOOL valueRequired;
...
// Used to set initial control values so that they could be rolled back later on if the user issues a 'Cancel' operation
 ...
 *	@param definition The definition of the selection objects.
 */
 ...
 *
 *	@param object The object that SCObjectCell will use to generate its detail view cells.
 *	@param definition The class definition for the object.
 */
 ...
 *
 *	@param cellItems An array of objects that the cell will use to generate its detail cells.
 *	@param definition The class definition of the class or entity of the objects in the objects array. If the array contains more than one type of object, then their respective class definitions must be added to the itemsClassDefinitions dictionary after initialization.
 */
